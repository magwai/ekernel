...
class k_form_element_coord extends form_element_input {
	...
	public function render() {
		...
		$this->view->js		->append('/'.DIR_KERNEL.'/ctl/coord/coord.js');
		if ($this->map_type == 'yandex') $this->view->js->append('http://api-maps.yandex.ru/2.1/?load=package.standard&lang=ru');
